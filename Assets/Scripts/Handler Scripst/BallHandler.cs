...
public class BallHandler : MonoBehaviour
{
    ...
    public void ResetGame()
    {
       ...
       // print("dönme2");
        ...
        //print("circle No:"+gameObject2.name);
    ...
    void FailScreen()
    {
        ...
        FindObjectOfType<ADManager>().RequestStart() ;
        Debug.Log("gecis reklam");
        FindObjectOfType<ADManager>().showAd();
    }

    public void DeleteAllCircles()
    {
       // print("DeleteAllCirclesqqq ");
        try
        {
            //print("DeleteAllCircles ");
    ...
    public void DeleteAllCircleHome()
    {
       // print("DeleteAllCirclesqqq ");
      
           // print("DeleteAllCircleHome ");
            GameObject[] array = GameObject.FindGameObjectsWithTag("circle");
            foreach (GameObject gameObject in array)
            {
                Destroy(gameObject.gameObject);
    ...
    public void HitBall()
    {
        print("Hitball ballsCount :"+ballsCount);
        if (ballsCount <= 1)
        {
    ...
    void MakeANewCircle()
    {
        //Debug.Log("make a bnew circle" + CircleCount);
